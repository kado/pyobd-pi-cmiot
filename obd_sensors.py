...
SENSORS = [
    ...
    Sensor("per_driver_torque", "Torque Driver's Demand", "0161", cpass, "%"),
    Sensor("per_engine_torque", "Actual Engine Torque", "0162", cpass, "%"),
    Sensor("ref_engine_torque", "Engine Reference Torque", "0163", cpass, "Nm"),
    Sensor("engine_percent_torque","Engine Percent Torque Data"	, "0164", cpass, "Nm"),
    Sensor("fuel_tank_level", "Fuel Tank Level Input", "012F", cpass, "%"),
    Sensor("actual_gear", "actual_gear", "01A4", cpass, "%"),
]
